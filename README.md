...
- [**6 DOF formation flight simulator**](https://github.com/pfroysdon/projects/blob/main/aerospace/6dof) used for analyzing flight profiles and peformance of formation flight of multiple aircraft.
