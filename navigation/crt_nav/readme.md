...
# Results
Below is an example **trajectory with high multi-path and GNSS signal errors and drop-outs (for 10's of seconds)**.  The CRT Nav with LSS outlier detection and removal is able to maintain a converged navigation solution throughout the trajectory whereas most navigation systems completely fail.  This work received several innovation awards and was the subject of my [Ph.D. dissertation](https://github.com/pfroysdon/publications/blob/main/Papers/Roysdon_PhD_Dissertation.pdf).
